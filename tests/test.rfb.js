// requires local modules: util, websock, rfb, input/util, input/keysym, input/keysymdef, input/devices, inflator, des, display, ast2100/ast2100util
...
var originalHandlers = {
    ...
    'pointerEvent': RFB.messages.pointerEvent
};
...
describe('Remote Frame Buffer Protocol Client', function() {
    ...
    describe('Protocol Initialization States', function () {
        ...
        describe('Authentication', function () {
            ...
            // @KK: 'types' may be either a single number or an array of numbers.
            ...
            describe('TightVNC Authentication (type 16) Handler', function () {
                ...
                beforeEach(function () {
                    ...
                    client._rfb_init_state = 'Security';
                    client._rfb_version = 3.8;
                    // @KK: Actual TightVNC servers support more than just 16 ("tight"), whereas ATEN iKVM servers
                    // advertise only 16.  This is a large part of how we detect that we are speaking to an iKVM server,
                    // so if we want to test the client's interaction with a TightVNC server, we need to send more than
                    // just the one.
            ...
            describe('ATEN iKVM Authentication Handler', function () {
                ...
                beforeEach(function () {
                    ...
                    client._rfb_init_state = 'Security';
                    client._rfb_version = 3.8;
                    // @KK: ATEN iKVM server advertise *only* 16 ("tight"), which is how we detect them.
    ...
    describe('Asynchronous Events', function () {
        describe('Mouse event handlers', function () {
            var client;
            beforeEach(function () {
                // This handler is replaced when an ATEN iKVM server is detected; let's restore the original behavior.
                RFB.messages.pointerEvent = originalHandlers.pointerEvent;
        ...
        describe('Keyboard Event Handlers', function () {
            ...
            beforeEach(function () {
                // This handler is replaced when an ATEN iKVM server is detected; let's restore the original behavior.
                RFB.messages.keyEvent = originalHandlers.keyEvent;
